...
plt.axis('off')
plt.title(" IMAGE WITH SAME PADDING ")
removedimage=removepadding(newimage)
fig.add_subplot(pltX, pltY, 3)
plt.imshow(cv2.cvtColor(removedimage,cv2.COLOR_BGR2RGB ))
plt.axis('off')
plt.title(" IMAGE AFTER PADDING REMOVAL ")
fig.show()
fig.waitforbuttonpress()
print(newimage.shape)
print(removedimage.shape)
fig = plt.figure(figsize=(18, 18))
pltX = 2
pltY = 2
...
fig.waitforbuttonpress()
# print("\n\n\nmax\n\n")
# print(max_filter_image)
# print("\n\n\nmin\n\n")
# print(min_filter_image)
# print("\n\n\nmean\n\n")
# print(mean_filter_image)
# print("\n\n\nmedian\n\n")
# print(median_filter_image)
